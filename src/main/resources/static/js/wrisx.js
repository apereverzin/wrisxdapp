        ...
        error: function() {
            ...
            $.get({
                ...
                success: function(data) {
                    ...
                    $("#expertPassword").prop('disabled', true);
                    $("#expertRepeatPassword").prop('disabled', true);
                    $("#expertProfileLink").prop('disabled', true);
                    $("#expertWebsiteLink").prop('disabled', true);
                },
                error: function() {
                    $("#expertName").val('');
                    ...
                    $("#expertPassword").prop('disabled', false);
                    $("#expertRepeatPassword").prop('disabled', false);
                    $("#expertProfileLink").prop('disabled', false);
                    $("#expertWebsiteLink").prop('disabled', false);
                }
            });
        }
    });
        ...
        error: function() {
            ...
            $.get({
                ...
                success: function(data) {
                    ...
                    $("#clientPassword").val(data.emailAddress);
                    $("#clientRepeatPassword").val(data.emailAddress);
                    $("#clientProfileLink").val(data.emailAddress);
                    $("#clientWebsiteLink").val(data.emailAddress);
                    $("#clientName").prop('disabled', true);
                    $("#clientEmailAddress").prop('disabled', true);
                    $("#clientPassword").prop('disabled', true);
                    $("#clientRepeatPassword").prop('disabled', true);
                    $("#clientProfileLink").prop('disabled', true);
                    $("#clientWebsiteLink").prop('disabled', true);
                },
                error: function() {
                    $("#clientName").val('');
                    ...
                    $("#clientRepeatPassword").prop('disabled', false);
                    $("#clientProfileLink").prop('disabled', false);
                    $("#clientWebsiteLink").prop('disabled', false);
                }
            })
        }
    });
...
function login() {
    ...
    var password = 'p';
    $.get({
        url: contextPath + "/login?emailAddress=" + emailAddress + "&password=" + password,
        success: function(data) {
            console.log('Success');
        },
        error: function() {
...
function showFacilitatorRoleTab() {
    address = getAddress();

    $.get({
        url: contextPath + "/facilitator/" + address,
        success: function(data) {
            $("#roleFacilitatorTabTitle").text('Expert');
//            $("#roleExpertTabs").show();
//            $("#registerExpertPanel").hide();
        },
        error: function() {
            $("#roleFacilitatorTabTitle").text('Become a Facilitator')
//            $("#roleExpertTabs").hide()
//            $("#registerExpertPanel").show()
//            $.get({
//                url: contextPath + "/user/" + address,
